...
<body>
	<form action="${pageContext.request.contextPath}/customer/findCustomer" method="get">
		<h1>Find Customer</h1>
		<h3>${errorMessage}</h3>
		<br> Customer Name <input type="text" name="customerName"> 
		<br> Customer Email <input type="text" name="customerEmail">
		<input type="submit" value="Find">
		<br> <a href="${pageContext.request.contextPath}/customer/addCustomer">New Customer</a>
	</form>
	<br>
	<table padding="6px" bordercolor="black">
		...
		<c:forEach items="${customers}" var="customer">
			...
			<tr id="tr{customer.id}">
				...
				<td><input onclick="update(${customer.id})" type="submit" value="Update"></td>
				<td id="td${customer.id}"><input onclick="removeCustomer(${customer.id})" type="submit" value="Delete"></td>
			</tr>
		</c:forEach>		
	</table>
<form:form>
