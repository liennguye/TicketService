...
<body>
	...
	<form style="margin-left: 5%;"
		action="${pageContext.request.contextPath}/customer/findCustomer"
		method="get">
		<h1 style="margin-left: 15px;">Find Customer</h1>
		<div>
		...
		<br>
		<label id="icon" for="customerName"><i class="icon-user"></i></label>
		<input type="text" name="customerName"
			placeholder="Type Name to Search"> <br> <label id="icon"
			for="customerEmail"><i class="icon-envelope"></i></label> <input
			type="text" name="customerEmail" placeholder="Type Email to Search">
		<input type="submit" value="Find" class="button" style="float: none;">
	...
	<table padding="6px" style="width: 90%;">
		...
		<c:forEach items="${customers}" var="customer">
			...
			<tr id="tr{customer.id}">
				...
				<td><input class="button" onclick="update(${customer.id})"
					type="submit" value="Update"></td>
				<td id="td${customer.id}"><input class="button"
