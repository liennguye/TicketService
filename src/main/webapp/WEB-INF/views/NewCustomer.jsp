	...
	<div class="testbox">
		...
		<form:form
			...
			<form:input path="address" class="form-control" name="address"
				...
				data-parsley-trigger="change" placeholder="Your Address" />

			<label id="icon" for="email"><i class="icon-envelope"></i></label>
			<form:input path="email" class="form-control" name="email"
				data-parsley-type="email" data-parsley-required="true"
				data-parsley-trigger="change" placeholder="Your Email" />

			<label id="icon" for="userInfo.username"><i class="icon-key"></i></label>
			<form:input disabled="${usernameDisabled}" path="userInfo.username"
				class="form-control" name="userInfo.username"
				data-parsley-required="true" data-parsley-trigger="change"
